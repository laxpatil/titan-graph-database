...
public class GraphOfTheGodsFactory {
    ...
    public static void main(String args[]) {
      ...
      Iterator<Vertex> itr= g.vertices("name","saturn");
       if(itr.hasNext())
       {
     ...
     // pipe.
      Iterator<Vertex> itr2=g.traversal().V().has("name", "lax");
      if(!itr2.hasNext())
      {
    	  System.out.println("Null");
      }
      else
      System.out.println("Vertex by API : "+itr2.next().value("name"));
      
    	//TitanGraph g = create("db");
